                    ...
                    <div class="flex flex-col gap-4 border-b pb-5 sm:flex-row sm:items-center">
                        <div class="flex items-start gap-3">
                            <div class="rounded-full bg-red-50 p-2.5 text-red-700">
                                <PenLine class="h-6 w-6 shrink-0" />
                            </div>
                            <div class="min-w-0">
                                <h1 class="text-xl font-semibold sm:text-2xl">Validation</h1>
                                <p class="mt-1 text-sm text-muted-foreground">
                                    Missions en attente de votre validation et signature. Les dossiers signés restent consultables ici.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr v-if="!missions.data.length">
                                    <td colspan="7" :class="missionEmptyState">
                                        Aucune mission en attente de signature DG.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
