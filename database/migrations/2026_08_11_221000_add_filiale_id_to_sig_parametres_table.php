...
return new class extends Migration
{
    ...
    {
        Schema::table('sig_parametres', function (Blueprint $table) {
        ...
        if ($senegalId) {
            DB::table('sig_parametres')->whereNull('filiale_id')->update(['filiale_id' => $senegalId]);
        }

        Schema::table('sig_parametres', function (Blueprint $table) {
            $table->unique('filiale_id');
        });
    }
